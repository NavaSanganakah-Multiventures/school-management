          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="flex items-center">
                <input value={form.subdomain} onChange={(e) => update('subdomain', e.target.value.toLowerCase().replace(/[^a-z0-9-]/g, ''))} placeholder="उदा. dps-jaipur" className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-l-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-600" />
