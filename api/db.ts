...
export const SUBSCRIPTION_PLANS: SubscriptionPlanDefinition[] = [
  {
    ...
    featureFlags: { reportCards: false, principalHistory: false, autopay: false, domainEmail: false, multiSchool: false, prioritySupport: false, customDomainIncluded: false, dedicatedWorker: true },
    active: true,
    isTrial: true,
    sortOrder: 0,
  },
  ...
  },
  {
    ...
    featureFlags: { reportCards: true, principalHistory: true, autopay: true, domainEmail: true, multiSchool: false, prioritySupport: true, customDomainIncluded: false, dedicatedWorker: true },
    active: true,
    isTrial: false,
    sortOrder: 2,
  },
